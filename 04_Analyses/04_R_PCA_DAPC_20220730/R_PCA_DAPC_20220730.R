...
### Alix Matthews
### 2022 July 30
##### Trying to get a loop for the 30 xvals in order to get a better estimate of the range to put in the 1000 xvals
##### Sticking with DP15 and LD01 for both species
...
scatter.dapc(cerw_dp15_ld01_dapc_cv1000$DAPC, cex = 2, legend = TRUE,
             ...
             posi.pca = "topleft", posi.da="none", xax = 1, yax = 2, inset.solid = 1, col=c("olivedrab", "darkorange2", "deepskyblue2", "darkorchid4", "firebrick"), pch=19, bg.inset = "gray97")
...
scatter.dapc(cerw_dp15_ld01_dapc_cv1000$DAPC, cex = 2, legend = FALSE,
             ...
             posi.da="none", xax = 1, yax = 2, inset.solid = 1, col=c("olivedrab", "darkorange2", "deepskyblue2", "darkorchid4", "firebrick"), pch=19, bg.inset = "gray97")
...
cerw_dp15_ld01_dapc_16_p <- ggplot(cerw_dp15_ld01_dapc_16.results, aes(x=Sample, y=Posterior_membership_probability, fill=Assigned_Pop)) +
  ...
  theme_few() +
  scale_fill_manual(values = c("olivedrab", "darkorange2", "deepskyblue2", "darkorchid4", "firebrick"), name = "Assigned\nPopulation") +
