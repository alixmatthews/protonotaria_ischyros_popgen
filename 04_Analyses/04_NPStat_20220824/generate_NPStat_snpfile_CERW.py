...
file_loc = r'/scrfs/storage/amatthews/20210816_projects/20210816_snp/03_SNP_20220513/RESULTS_ref_reduced_concat_CERW/CERW_ALL_renamed_q30_minac1_maf05_dp15_maxmiss100_ld01.prune.intervals.forbams_final.bed' # change this to your input file location
folder = r'/scrfs/storage/amatthews/20210816_projects/20210816_snp/03_SNP_20220513/RESULTS_ref_reduced_concat_CERW' # change this to the location you want the output file saved
...
filename = 'CERW_ref_reduced_concat_snpfile.snp' # change this to your desired output filename
